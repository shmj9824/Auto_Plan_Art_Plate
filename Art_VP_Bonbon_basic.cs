...
{
    internal class Art_VP_Bonbon_Basic
    {
        ...
        bool plus_year;
        public Art_VP_Bonbon_Basic(string file_name, List<Bonbon_Basic_vpdata> vP_Datas, Dictionary<string, (string, string)> dic_po_no,bool plus_year, SaveFileDialog saveFileDialog1)
        { 
            fn = file_name;
            bonbon_Vps = vP_Datas;
        ...
        public Art_VP_Bonbon_Basic(string file_name, List<Bonbon_Basic_vpdata> vP_Datas, SaveFileDialog saveFileDialog1)
        {
            fn = file_name;
            bonbon_Vps = vP_Datas;
            this.saveFileDialog1 = saveFileDialog1;
        ...
        public void Bonbon_check_vp()
        {
            ...
            int data_count = 0;
            int page_count = 1;
            foreach (Bonbon_Basic_vpdata bb_Vp in bonbon_Vps)
            {
                ...
                Getbyname_TextFrame("Ingredient1", data_tfs).Contents = bb_Vp.Ingredient1;
                Getbyname_TextFrame("Ingredient2", data_tfs).Contents = bb_Vp.Ingredient2;
                Getbyname_TextFrame("Ingredient3", data_tfs).Contents = bb_Vp.Ingredient3;
        ...
        public void Bonbon_plate_vp()
        {
            ...
            foreach (Bonbon_Basic_vpdata _Vp_Data in bonbon_Vps)
            {
                ...
                Getbyname_TextFrame("Ingredient1", data_tfs).Contents = _Vp_Data.Ingredient1;
                Getbyname_TextFrame("Ingredient2", data_tfs).Contents = _Vp_Data.Ingredient2;
                Getbyname_TextFrame("Ingredient3", data_tfs).Contents = _Vp_Data.Ingredient3;
        ...
        string Set_describe_str(string describle_str, Bonbon_Basic_vpdata bonbon_Vp)
        {
            string temp_str;
